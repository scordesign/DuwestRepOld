            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Crear Blancos Biologicos</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('blancosbiologicos.store') }}"  role="form" enctype="multipart/form-data">
                            @csrf
