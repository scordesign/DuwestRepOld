            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Blancos biologicos</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('blancosbiologicos.update', $blancosbiologico->id) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf

                            @include('blancosbiologico.form')
